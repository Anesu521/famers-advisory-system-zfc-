...
CREATE TABLE IF NOT EXISTS `regions` (
  ...
  `percentage_land_area` varchar(30) NOT NULL,
  `annual_rainfall` varchar(255) NOT NULL,
  `farming_systems` varchar(255) NOT NULL
...
INSERT INTO `regions` (`region_id`, `region_name`, `area`, `percentage_land_area`, `annual_rainfall`, `farming_systems`) VALUES
(1, 'natural region 1', '613 000 ha', '1.56 %', '> 1 000m. Rain in all months of the year, relatively low temperatures', 'Suitable for dairy farming forestry, tea, coffee, fruit, beef and maize production'),
(2, 'natural region 2', '7 343 000 ha', '18.68 %', '700  - 1 050mm. Rainfall confined to summer', 'Suitable for intensive farming, based on maize, tobacco, cotton and livestock'),
(3, 'natural region 3', '6 855 000 ha', '17.43 %', '500-800. Relatively high temperatures and infrequent, heavy falls of rain, and subject to seasonal droughts and severe mid-season dry spells', 'Semi-intensive farming region. Suitable for livestock production, together with production of fodder crops and cash crops under good farm management'),
(4, 'natural region 4', '13 010 036 000 ha', '33.03 %', '450-650. Rainfall subject to frequent seasonal droughts and severe dry spells during the rainy season', 'Semi-extensive region. Suitable for farm systems based on livestock and resistant fodder crops. Forestry, wildlife/tourism'),
(5, 'natural region 5', '10 288 000 ha', '26.2 %', '< 450. Very erratic rainfall. Northern low veldt may have more rain but the topography and soils are poor', 'Extensive farming region. Suitable for extensive cattle ranching. Zambezi Valley is infested with tsetse fly. Forestry, wildlife/tourism');
