	...
	if (empty($username) || empty($password)) {
		...
		if ($password === $confirmPassword) {		
			...
			exit();
				...
				$passwordQuery = mysqli_query($connect, "INSERT INTO agronomists (name, surname, username, email, phone, password, gender, date_created, time_created) VALUES ('$name', '$surname', '$username', '$email', '$phone', '$encryptedPassword', '$gender', CURDATE(), CURTIME())");
